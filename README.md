...
**成果演示 · Result**（`assets/sato_live2d_anim_v9.mp4`，48 帧 / 24fps / 2s 循环）：
...
**可编辑工程 · Editable project**: `assets/sato_sugar_rig_v9.stretch`（在 [Stretchy Studio](https://editor.stretchy.studio/) 打开继续编辑）
...
4. 切 Animation 模式 → 时间轴加关键帧（照抄 `assets/sato_sugar_rig_v9.stretch` 的轨道设置即可）。
...
└── assets/
    ...
    ├── sato_live2d_anim_v9.mp4   # 最终动画演示
    └── sato_sugar_rig_v9.stretch # 可编辑工程
```
